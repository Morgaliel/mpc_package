...
class f1tenth_mpc_node(Node):
    def __init__(self):
        ...
        wp_x = [-1.2,   0.0,    3.0,    6.8,    10.6,   14.3,   18.0,   21.6,   25.2,   28.4,
                ...
                18.6,   17.0,   15.7,   15.1,   15.9,   17.3,   18.9,   18.4,   17.1,   14.0,   
                11.2,   7.5,    3.9,    0.2,    -3.5,   -7.1,   -10.5,  -13.4,  -16.0,  -18.3,  
                -20.5,  -22.9,  -25.8,  -28.9,  -28.9, -27.7,   -26.0,  -24.0,  -21.0,  -17.9,  
                -14.8,  -11.2,  -7.6,   -5.3,   -4.5,   -3.5,   1.4]
        ...
        wp_y = [0.0,    0.0,    0.3,    0.2,    0.2,    0.5,    1.2,    2.2,    3.3,    4.6,    
                ...
                41.3,   40.5,   38.8,   35.1,   31.5,   28.1,   24.5,   20.8,   18.9,   18.8,   
                18.3,   17.7,   17.0,   16.1,   15.5,   14.6,   13.0,   10.7,   7.9,    5.0,    
                1.9,    -0.9,   -3.4,   -5.8,   -7.45,  -9.5,   -10.8,  -10.3,  -8.1,   -6.1,   
                -4.2,   -3.0,   -2.6,   -2.3,   -0.8,   -0.1,   0.1]
        ...
        v_max = 10.0                # m/s baseline = 5          max = 10
        self.delta_max = np.pi/3.0  # rad
        ay_max = 8.0                # m/s^2 baseline = 8        max = 8
        self.ax_min = -7.0          # m/s^2 (baseline = -1)     min = -7
        self.ax_max = 4.0           # m/s^2 (baseline = 1)      max = 4
