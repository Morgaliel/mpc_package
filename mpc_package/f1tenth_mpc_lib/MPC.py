...
class MPC:
    ...
    def get_control(self):
        ...
        # self.model.get_current_waypoint() #commented due to getting current waypoint in f1tenth_mpc.py
    ...
    def update_prediction(self, spatial_state_prediction):
        ...
        for n in range(2, self.N):
            ...
            psi_pred.append(predicted_temporal_state.psi)

        return x_pred, y_pred, psi_pred
