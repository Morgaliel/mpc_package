...
class ReferencePath:
    def __init__(self, map1, wp_x, wp_y, resolution, smoothing_distance,
                 max_width, circular):
        """
    ...
    def _construct_path(self, wp_x, wp_y):
        ...
        # Number of waypoints dla danego resolution 
    ...
    def update_path_constraints(self, wp_id, N, min_width, safety_margin):
        ...
        for n in range(N):
            ...
            if n == 0:
                ...
                ls_id = segment_lengths.index(max(segment_lengths)) #TODO: problemy
